...
def train_alpha_tensor(
    ...
    """Trains an AlphaTensor model to learn more efficient matrix multiplications and returns it.
    ...
    Args:
        ...
        limit_rank (int): Maximum number of steps per episode and maximum rank for synthetically-generated matrices.
        n_actors (int): Number of actors to play a single each game at each training step.
