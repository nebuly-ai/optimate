...
class TrainingOperation(Operation):
    r"""Operation which trains an AlphaTensor model to learn more efficient matrix multiplications."""
    ...
    def execute(
        ...
        Args:
            ...
            last_epoch (int): Latest epoch reached during training from which checkpoint data will be loaded,
