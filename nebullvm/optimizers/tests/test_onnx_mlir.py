...
from nebullvm.inference_learners.onnx_mlir import ONNX_MLIR_INFERENCE_LEARNERS
from nebullvm.optimizers.onnx_mlir import ONNXMlirOptimizer
...
def test_onnxruntime(output_library: DeepLearningFramework, dynamic: bool):
    with TemporaryDirectory() as tmp_dir:
        ...
        optimizer = ONNXMlirOptimizer()
        model = optimizer.optimize(model_path, output_library, model_params)
        assert isinstance(model, ONNX_MLIR_INFERENCE_LEARNERS[output_library])
